...
.. todo:: základní info  o `R <https://cran.r-project.org/>`_  
...
.. todo:: další informace R, příkazová řádka, Rstudio, jiný textový editor/IDE (Geany)
...
.. only:: latex
   ...
   * http://training.gismentors.eu/r-gis-zacatecnik/

Zdrojové texty školení jsou dostupné na adrese:

* https://github.com/GISMentors/r-gis-zacatecnik

Případné chyby nebo náměty na vylepšení můžete hlásit:

* https://github.com/GISMentors/r-gis-zacatecnik/issues
